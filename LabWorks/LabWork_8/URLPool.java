...
public class URLPool
{
    ...
    //если список неотсмотренных пустой, поток ставится на ожидание и кол-во ожид. потоков становится на 1 больше
    //иначе мы вынимаем из списка неотсмотренных первую пару, добавляем в просмотр. и возвращаем
    ...
    //если кол-во ожид.потоков > 0, то ожидающих потоков становится меньше на 1
